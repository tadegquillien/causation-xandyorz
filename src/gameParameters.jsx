...
export const condition = Math.random() > .5 ? "two" : "three"
...
//Urn 1 is the rare color, and has 95% of colored balls
//Urn 2 has the frequent color, and has 5% of colored balls
//Urn 3 has the frequent color, and has 90% of colored balls
...
const thirdurnoutcome = condition === "two" ? 0 : 1;
export const actualWorld = timesPower([1,1,thirdurnoutcome]);
...
const secondUrn = Math.random() > .5 ? 1 : 0;

const urnSequences = [
    
    shuffle([1,1,1,1,1,1,1,1,1,firstUrn]),
    shuffle([0,0,0,0,0,0,0,0,0,secondUrn]),
    shuffle([1,1,1,1,1,1,1,1,1,0])
]
