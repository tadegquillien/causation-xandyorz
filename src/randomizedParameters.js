...
import { circle_ids, mode, urn_ids, urn_letters, PROBS, colors, actualWorld, 
    threshold } from './gameParameters'




//determines which color is the rare one
export const importantcolor = Math.random() > .5 ? "orange" : "purple";
export const othercolor = importantcolor === "purple" ? "orange" : "purple";
export const color_palette = [importantcolor, othercolor, othercolor];
