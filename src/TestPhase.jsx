...
const TestPhase = (props) => {
    ...
    //adds an "s" to 'Joe drew X ball(s)' if he drew more than one
    const plural = props.test_ids.length - 1 > 1.01 ? "s": "";
    ...
    const outcome = props.test_ids.length >= 2 ? "The player won" : "The player lost";
    ...
    const introduction = <div style={{backgroundColor: "lightgrey"}}>
        ...
        <h3>
            ...
            Joe drew 1 {importantcolor} ball
            and {props.test_ids.length - 1} {othercolor} ball{plural}, so he won the game. <br></br>
        ...
        <span className="metaContainer">
            ...
            <span className="containerTest">
                <div className="scoreboardTest">
                    ...
                    <h1>Player's score: 1 {importantcolor} ball and {props.test_ids.length - 1} {othercolor} ball{plural}.</h1><br></br>
                    <h1>{outcome}</h1>
                </div>
